...
public class YoneticiGiris extends JFrame {
	...
	public YoneticiGiris() throws IOException {
		setTitle("Yıldız Kültür Merkezi");
		setIconImage(Toolkit.getDefaultToolkit().getImage(YoneticiGiris.class.getResource("/resimler/logo2.png")));
		...
		emailArea.setFont(new Font("Monospaced", Font.PLAIN, 15));
		emailArea.setOpaque(false); 
		emailArea.setBounds(15, 15, 361, 52);
		...
		passwordField.setForeground(new Color(106, 106, 106));
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Islemler yoneticiDAO = new Islemler();
				if(yoneticiDAO.loginAdmin(emailArea.getText(), passWord2 )) {
					System.out.println("basarili");
					YoneticiAnaSayfasi y;
					try {
						y = new YoneticiAnaSayfasi();
		...
		JLabel lblNewLabel_1 = new JLabel("Yönetici Giriş Sayfası");
		lblNewLabel_1.setForeground(new Color(117, 117, 117));
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel_1.setBounds(238, 136, 227, 33);
		...
		lblNewLabel_3.setBounds(228, 72, 550, 71);
